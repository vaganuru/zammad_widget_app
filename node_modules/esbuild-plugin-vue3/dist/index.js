                    ...
                    switch (_c.label) {
                        ...
                        case 1:
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            script = (descriptor.script || descriptor.scriptSetup) ? sfc.compileScript(descriptor, { id: id, fs: typescript_1.default.sys }) : undefined;
                                            dataId = "data-v-" + id;
                                            code = "";
                            ...
                            build.onLoad({ filter: /.*/, namespace: "sfc-style" }, function (args) { return cache.get([args.path, args.namespace], function () { return __awaiter(_this, void 0, void 0, function () {
                                var _a, descriptor, index, id, style, includedFiles, result, errors, cssText, contents;
                                var _b, _c;
                                ...
                                return __generator(this, function (_h) {
                                    switch (_h.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, (0, html_1.generateIndexHTML)(result, opts.generateHTML, (_d = buildOpts.minify) !== null && _d !== void 0 ? _d : false, opts.cssInline ? generatedCSS : undefined)];
                                        case 1:
                                            _h.sent();
                                            _h.label = 2;
